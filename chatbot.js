...
client.on('message', async msg => {
    ...
    if (msg.body.match(/(menu|Menu|dia|tarde|noite|oi|Oi|Olá|olá|ola|Ola)/i) && msg.from.endsWith('@c.us')) {
        ...
        await client.sendMessage(msg.from,'Olá! '+ name.split(" ")[0] + 'Olá, seja bem-vindo ao nosso atendimento  !DIGITE APENAS O‼️*NÚMERO*‼️DE SUA ESCOLHA, PARA FACILITAR O ATENDIMENTO! \n\n1 - TV Box\n2 - Smart TV\n3 - Celular Android\n4 - Computador/Notebook\n5 - Falar com atendente'); //Primeira mensagem de texto
        await delay(3000); //delay de 3 segundos
        await chat.sendStateTyping(); // Simulando Digitação
